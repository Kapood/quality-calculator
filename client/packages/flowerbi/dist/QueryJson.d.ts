 ...
 */
export declare type FilterOperator = "=" | "<>" | ">" | "<" | ">=" | "<=" | "IN" | "NOT IN" | "BITS IN" | "LIKE";
/**
 * The allowed value types for a filter.
 */
export declare type FilterValue = string | number | boolean | Date | unknown | string[] | number[];
/**
 ...
 * zero-based position.
 */
export declare type OrderingJson = {
    descending?: boolean;
} & ({
    column: string;
} | {
 ...
 */
export declare type CalculationJson = {
    value: number;
} | {
    aggregation: number;
} | {
