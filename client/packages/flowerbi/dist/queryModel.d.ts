 ...
 */
export declare type SelectMember = QueryColumn<any> | AggregationJson;
/**
 * The `select` object of a query has named properties of type {@link SelectMember}.
 */
export declare type QuerySelect = Record<string, SelectMember>;
/**
 * Extracts the data type from a column. So `QueryColumnType<QueryColumn<boolean>>` is `boolean`.
 */
export declare type QueryColumnType<T> = T extends QueryColumn<infer C> ? C : never;
/**
 ...
 */
export declare type ExpandedQueryRecord<S extends QuerySelect, C extends QueryCalculations<S>> = {
 ...
 */
export declare type ExpandedQueryRecordWithOptionalColumns<S extends QuerySelect, C extends QueryCalculations<S>> = {
 ...
 */
export declare type AggregatePropsOnlyHelper<T extends QuerySelect> = {
 ...
 */
export declare type AggregatePropsOnly<T extends QuerySelect> = AggregatePropsOnlyHelper<T>[keyof AggregatePropsOnlyHelper<T>];
/**
 ...
 */
export declare function getAggregatePropsOnly<T extends QuerySelect>(select: T): AggregatePropsOnly<T>[];
/**
 ...
 * type `number`.)
 */
export declare type AggregateValuesOnly<T extends QuerySelect> = {
    [K in AggregatePropsOnly<T>]: number;
};
export declare type CalculationValues<C extends QueryCalculations<any>> = {
    [K in keyof C]: number;
};
/**
 * A helper type used in the definition of {@link ColumnPropsOnly}.
 */
export declare type ColumnPropsOnlyHelper<T extends QuerySelect> = {
 ...
 */
export declare type ColumnPropsOnly<T extends QuerySelect> = ColumnPropsOnlyHelper<T>[keyof ColumnPropsOnlyHelper<T>];
/**
 ...
 * @param select the `select` object from a query
 */
export declare function getColumnPropsOnly<T extends QuerySelect>(select: T): ColumnPropsOnly<T>[];
/**
 * Returns the plain column objects referred to in a query, ignoring
 * aggregated columns.
 * @param select the `select` object from a query
 */
export declare function getColumnsOnly(select: QuerySelect): QueryColumn<any>[];
export declare type Calculation<S extends QuerySelect> = number | AggregatePropsOnly<S> | [Calculation<S>, "+" | "-" | "*" | "/" | "??", Calculation<S>];
/**
 * The `select` object of a query has named properties of type {@link SelectMember}.
 */
export declare type QueryCalculations<S extends QuerySelect> = Record<string, Calculation<S>>;
export declare type Ordering<S extends QuerySelect, C extends QueryCalculations<S>> = {
    descending?: boolean;
} & ({
    select: keyof S;
} | {
