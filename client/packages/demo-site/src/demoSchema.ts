...
export const CategoryCombination = {
    ...
    Crashed: new QueryColumn<boolean>("CategoryCombination.Consistency"),
    DataLoss: new QueryColumn<boolean>("CategoryCombination.Consistency"),
    SecurityBreach: new QueryColumn<boolean>("CategoryCombination.Consistency"),
    OffByOne: new QueryColumn<boolean>("CategoryCombination.Consistency"),
    Slow: new QueryColumn<boolean>("CategoryCombination.Consistency"),
    StackOverflow: new QueryColumn<boolean>("CategoryCombination.Consistency"),
};
